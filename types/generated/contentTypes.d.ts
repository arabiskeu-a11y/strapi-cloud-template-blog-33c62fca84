...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    new_content: Schema.Attribute.RichText &
      Schema.Attribute.Required &
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    Property_Rights: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    Super_image: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiLegalPageLegalPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    CookieBannerMessage: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    CookiePolicy: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
...
export interface ApiPublishingHousePublishingHouse
  extends Struct.CollectionTypeSchema {
  collectionName: 'publishing_houses';
  info: {
    displayName: 'Publishing House';
    pluralName: 'publishing-houses';
    singularName: 'publishing-house';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::publishing-house.publishing-house'
    >;
